...
const appDirectory = path.join(process.cwd(), "app", "apps", "clean-tasks");

describe("Clean Tasks guide page", () => {
  it("uses the shared Guide shell and explains the demo persistence limit", async () => {
    ...
    expect(guidePage).toContain("サーバーの再起動や再デプロイで消える");
