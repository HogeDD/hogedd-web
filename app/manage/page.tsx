    ...
    <div>
      ...
      <section className="mt-12" aria-labelledby="management-sections">
        ...
        <div className="mt-4 border-t border-[var(--border)]">
          <div className="grid gap-2 border-b border-[var(--border)] py-5 sm:grid-cols-[12rem_1fr_auto] sm:items-center">
            <span className="font-medium text-[var(--foreground)]">コンテンツ</span>
            <span className="text-sm text-[var(--muted)]">アプリの登録・編集・公開</span>
            <span className="text-xs font-medium text-[var(--muted)]">準備中</span>
          </div>
        </div>
      </section>
    </div>
